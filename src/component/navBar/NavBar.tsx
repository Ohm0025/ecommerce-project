...
const NavBar = (props: Props) => {
  return (
    <div className="order-2 flex items-center flex-1 justify-end gap-7 pr-5">
      <button className="flex flex-col items-center nav-bar-btn">
        ...
        <span className="hidden text-[14px] text-[#8b96a5]">My Cart</span>
      </button>
      <button className="flex flex-col items-center nav-bar-btn">
        <svg
          className="fill-[#8b96a5]"
        ...
        <span className="hidden text-[14px] text-[#8b96a5]">Profile</span>
      </button>
    </div>
  );
};
